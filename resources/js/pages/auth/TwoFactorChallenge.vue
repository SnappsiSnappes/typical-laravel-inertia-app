...
// 1. Сначала объявляем реактивные переменные
const showRecoveryInput = ref<boolean>(false);
const code = ref<string>('');

// 2. Теперь можно использовать их в computed
...
// 3. WatchEffect тоже должен идти после того, как все зависимости объявлены
watchEffect(() => {
    setLayoutProps({
